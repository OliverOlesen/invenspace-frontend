...
async function onSubmit() {
  ...
  if (!isValid) return; // Form invalid, stop here
          ...
          <div class="w-100">
            ...
            <div class="text-center mb-5">
              ...
              <p class="fw-medium text-muted">
                ...
                <RouterLink :to="{ name: 'user.signUp' }">sign up</RouterLink>
                for a new account.
              </p>
            </div>
            <!-- END Header -->
              ...
              <div class="col-sm-8 col-xl-4">
                <form @submit.prevent="onSubmit">
                  ...
                  >
                    <div>
                      <RouterLink
                        :to="{ name: 'user.forgotPassword' }"
                        class="fs-sm fw-medium d-block d-lg-inline-block mb-1"
                      >
                        Forgot Password?
                      </RouterLink>
                    </div>
