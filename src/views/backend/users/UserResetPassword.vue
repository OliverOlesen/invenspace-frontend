...
const url = `http://localhost:80/api/security/reset/password`;
...
onBeforeMount(async () => {
  await loadData();
  formValues.value.token = route.params.token.toString();
});
        ...
        <div class="p-4 w-100 flex-grow-1 d-flex align-items-center">
          <div class="w-100">
            ...
            <div class="text-center mb-5">
              ...
              <h1 class="fw-bold mb-2">Set A New Password</h1>
              <p class="fw-medium text-muted">
                Please set your new password,
                and repeat it before confirming.
              </p>
            </div>
            <!-- END Header -->
